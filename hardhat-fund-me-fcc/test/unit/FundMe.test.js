...
!developmentChains.includes(network.name)
    ...
    : describe("FundMe", function () {
          ...
          beforeEach(async () => {
              ...
              const { deployer: deployerSigner } = await ethers.getSigners()
            ...
            //   fundMe = await deployments.getContract("FundMe", deployer)
            //   mockV3Aggregator = await deployments.getContract(
            //       "MockV3Aggregator",
            //       deployer
            //   )
          })
